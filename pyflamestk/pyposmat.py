...
class PyPosmatError(Exception):
    """ generic error class to be developed later
    """
    ...
    def evaluate_parameter_set(self, potential_parameters):
        ...
        for simulation in self.lammps_sims:
            ...
            self.create_lammps_simulation(sim_name=simulation,
                                          ...
                                          fname_sim_template=fname_sim_template,
    ...
    def get_properties_from_simulations(self):
        ...
        for qoi_key in self.qoi_list:
            ...
            if variable_name == 'latt_a':
                ...
                err_msg = "pyposmat qoi not supported: {}"
                err_msg = err_msg.format(variable_name)
...
class QoiConfigFile:
    """ Class for reading the Qoi Configuration File
    """
    def __init__(self, 
                 fname_config = "pyposmat.potential",
                 is_read = True):
        ...
        fname_config ("pyposmat.potential",str) - string containing the filename
