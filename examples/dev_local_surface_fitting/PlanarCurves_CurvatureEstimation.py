...
if __name__ == "__main__":
    ...
    thetas.sort()
    x = np.random.uniform(0,5 * np.pi ,100)
    x = np.sort(x)
    y = np.sin(x)
    ...
    r = 0.5
    CurvatureEstimator.compute_all_curvatures(r)
