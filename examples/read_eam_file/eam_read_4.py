...
def func_pair_effective_charge(r, a1, a2, rc):
    # Ref: Foiles PhysRevB 32 3409 (1wha 985)
...
eam_file1 = pyflamestk.eam_tools.EamFileReader(eam_filename)
eam_file1.read()
curve_fitter = pyflamestk.eam_tools.EamCurveFitter(element_names = ['Ni'])
...
eam_file2  = pyflamestk.eam_tools.EamFileWriter(\
                 title = "effective_charge/5smetal/universal",
                 elements = ['Ni'],
...
eam_file3 = pyflamestk.eam_tools.EamFileReader(eam_filename2)                                          
eam_file3.read()
