...
mc_sampler = pyposmat.PyPosmatEngine(is_restart = True, random_seed = None)
mc_sampler.sampler_type = 'kde'
mc_sampler.sample_parameter_space(n_simulations,'results.out','kde','20170201_culled_10k.out')
